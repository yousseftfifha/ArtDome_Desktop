...
String chemin = "";
 ...
 //   private Pane contenu;
    ...
    void pdfs (ActionEvent event) throws SQLException {
        ...
        ResultSet rs;
        rs = con.createStatement().executeQuery("SELECT r.id_reservation,r.idclient,r.prix_total,r.Cautionnement,r.matricule,r.date_debut,r.date_fin, c.nom  ,c.prenom  FROM reservation r INNER JOIN user as c ON r.idclient = c.ID ");
