...
public class OeuvreItem implements Initializable {
    ...
    public void AfficherProduits() throws Exception
    {
        ...
        image.setStyle("-fx-alignment : center; -fx-font-weight:bold; -fx-font-family: 'Segoe Print'; -fx-font-size: 17; -fx-text-fill: #ffffff ");
        Label nom = new Label("Nom du produit");
        nom.setStyle("-fx-alignment : center; -fx-font-weight:bold; -fx-font-family: 'Segoe Print'; -fx-font-size: 17; -fx-text-fill: #ffffff ");
        Label prix = new Label("Prix unitaire");
        Label update = new Label("Action");
        update.setStyle("-fx-alignment : center; -fx-font-weight:bold; -fx-font-family: 'Segoe Print'; -fx-font-size: 17; -fx-text-fill: #ffffff ");
        ...
        prix.setStyle("-fx-alignment : center; -fx-font-weight:bold; -fx-font-family: 'Segoe Print'; -fx-font-size: 17; -fx-text-fill: #ffffff");
        ...
        for(Oeuvre m : myList)
        {
            ...
            nomque.setStyle("-fx-padding : 20 20 0 35;-fx-text-fill: #000000; -fx-font-weight:bold; -fx-font-family: 'Segoe Print'; -fx-font-size: 17;");

            URL l_url = new URL("http://localhost:8080/artdome/"+m.getImage ());
            ...
            prixl.setStyle("-fx-padding : 20 20 0 35;-fx-text-fill: #000000; -fx-font-weight:bold; -fx-font-family: 'Segoe Print'; -fx-font-size: 17;");
