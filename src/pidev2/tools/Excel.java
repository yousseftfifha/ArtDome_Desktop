...
public class Excel {
      ...
      public void Excel() throws SQLException, WriteException, IOException{
        ...
        String requete = "Select r.code_reservationE, r.nb_place, r.code_expo, u.nom, u.prenom, u.email, u.numero FROM reservation_expo r INNER JOIN user u ON r.code_client = u.id_user ORDER BY code_reservationE DESC";
        ...
        // * Sheet 1 ***//
        workbook = Workbook.createWorkbook(new File("C:\\Users\\Oumaima\\Documents\\NetBeansProjects\\RéservationExpo\\Réservation.xls"));
...
Desktop.getDesktop().open(new File("C:\\Users\\Oumaima\\Documents\\NetBeansProjects\\RéservationExpo\\Réservation.xls"));
    }
