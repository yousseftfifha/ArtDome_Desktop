...
public class Event {
    ...
    public Event(int code_event, String nom_event, String theme_event, String etat, Date date, int nb_participant, int nb_max_part, String image, String video, int code_espace, Client code_artiste) {
        this.code_event = code_event;
        this.nom_event = nom_event;
        this.theme_event = theme_event;
        this.etat = etat;
    ...
    public Client getCode_artiste() {
        return code_artiste;
    }

    public void setCode_artiste(Client code_artiste) {
        this.code_artiste = code_artiste;
    }
    ...
    public String toString() {
        return "Event{" + "code_event=" + code_event + ", nom_event=" + nom_event + ", theme_event=" + theme_event + ", etat=" + etat + ", date=" + date + ", nb_participant=" + nb_participant + ", nb_max_part=" + nb_max_part + ", image=" + image + ", video=" + video + ", code_espace=" + code_espace + ", code_artiste=" + code_artiste + '}';
    }
