...
public class PDFreservation {
     ...
     public void ReservationPDFback() throws FileNotFoundException, DocumentException, MalformedURLException, IOException
    {
        ...
        PdfWriter.getInstance(document, new FileOutputStream (new File ("C:/Users/HP/Documents/NetBeansProjects/Réservations/Réservation.pdf")));
        document.open();
        ...
        document.close ();
        Desktop.getDesktop().open(new File("C:/Users/HP/Documents/NetBeansProjects/Réservations/Réservation.pdf"));
    }
}
