...
public class Excel {
    ...
    public void Excel() throws SQLException, WriteException, IOException{
        ...
        String requete = "Select r.code_reservation, r.nb_place, r.code_event, u.nom, u.prenom, u.email, u.numero FROM reservation r INNER JOIN user u ON r.code_client = u.id_user ORDER BY code_reservation DESC";
